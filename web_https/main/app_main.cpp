...
extern "C" void app_main()
{
    ...
    ESP_LOGI(TAG, "📹 Camera feed displaying on 240x240 LCD screen");
    ESP_LOGI(TAG, "🌐 Web interface available for remote camera viewing");
    ESP_LOGI(TAG, "Press any ESP32-S3-EYE button to capture and send images via HTTPS POST (insecure mode)");
}
